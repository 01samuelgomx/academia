                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="service-page-single">
                        <div class="page-img mb-50">
                            <img src="{{ asset('img/musculacao.jpeg') }}" alt="img">
                        </div>
                        <div class="page-content">
                            <h2 class="page-title">Treinamento De Campeões</h2>
                            <p class="mb-30">No universo do fisiculturismo, o treino de alta intensidade é a chave para
                                desencadear o desenvolvimento muscular desejado. Nosso programa é especialmente elaborado
                                para amantes da musculação que buscam não apenas a estética, mas também a funcionalidade e a
                                força.
                                Se você é um atleta sério em busca de ganhos musculares impressionantes, nossa abordagem de
                                treino de alta intensidade é projetada para levar seus resultados ao próximo nível.
                            </p>
                            <p class="mb-50">Adotamos uma abordagem progressiva, variando o treinamento para evitar
                                adaptações e garantir resultados contínuos. Ajustamos a intensidade ao longo do tempo para
                                otimizar o crescimento muscular.Contamos com treinadores especializados em fisiculturismo,
                                prontos para oferecer orientação personalizada. Desde ajustes na forma até conselhos
                                nutricionais específicos, nossa equipe está comprometida em impulsionar o seu sucesso.</p>
